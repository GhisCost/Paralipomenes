 ...
 */
final class Version20260326103259 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE messages (id INT AUTO_INCREMENT NOT NULL, destinataire_id INT NOT NULL, expediteur_id INT NOT NULL, contenu LONGTEXT NOT NULL, date_envoi DATE NOT NULL, INDEX IDX_DB021E96A4F84F6E (destinataire_id), INDEX IDX_DB021E9610335F61 (expediteur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
